        ...
        mDatabase.child("users").child(userId).setValue(user)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(FirebaseTestActivity.this, "저장을 완료했습니다.", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        // Write failed
                        Toast.makeText(FirebaseTestActivity.this, "저장을 실패했습니다.", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        mDatabase.child("users").child("1").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.getValue(user.class) != null){
                    ...
                    Toast.makeText(FirebaseTestActivity.this, "데이터 없음...", Toast.LENGTH_SHORT).show();
                }
            }
